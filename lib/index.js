...
var AxiosQueue = {
  ...
  create: function create(options, config) {
    ...
    var _config$options = Object.assign({}, config, options);
        ...
        _config$options.onError;
        var onCancel = _config$options.onCancel;
    ...
    var promise = new Promise( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(resolve, reject) {
        var instance, processing, _iterator, _step, request;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                onRequest && instance.interceptors.request.use(onRequest, onRequestError); // 添加一个响应拦截器

                onResponse && instance.interceptors.response.use(onResponse, onResponseError); // 需要等待的队列
